                                    ...
                                    <div class="product_meta">
                                        <span style="color: black;"><b>Lab Name:</b>
                                            ...
                                            <span style="color: black;"><b>Address: </b>
                                                ...
                                                <br />
                                                <a href="cart.html" class="vs-btn style2"
                                                    style="background-color: blue; color: white;">Add To Cart<i
                                                        class="fas fa-chevron-right"
                                                        style="background-color: blue;"></i></a>
                                                <a href="cart.html" class="vs-btn style2"
                                                    style="background-color: blue; color: white;">Get Call Back<i
                                                        class="fas fa-chevron-right"
                                                        style="background-color: blue;"></i></a>
                                            </span>
                                        </span>
