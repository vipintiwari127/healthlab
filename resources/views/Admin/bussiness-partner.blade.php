        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                    data-bs-target="#exampleLargeModal">Add Bussiness Partner</button>
                <hr />
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-md-12">
                                        <label for="bsValidation1" class="form-label">Primary Email</label>
                                        <input type="text" class="form-control" id="bsValidation1"
                                            placeholder="Primary Email" required="">
                                        <div class="invalid-feedback">
                                            Please choose a Primary Email.
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="bsValidation1" class="form-label">Secondary Email</label>
                                        <input type="text" class="form-control" id="bsValidation1"
                                            placeholder="Secondary Email" required="">
                                        <div class="invalid-feedback">
                                            Please choose a Secondary Email.
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="bsValidation1" class="form-label">Redirect To </label>

                                        <select name=""class="form-control" id="bsValidation1"
                                            placeholder="Redirect To " required="">
                                            <option value="">Selet </option>
                                            <option value="website">Website</option>
                                            <option value="query-form">Query Form</option>
                                        </select>
                                        <div class="invalid-feedback">
                                            Please choose a Redirect To .
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="bsValidation1" class="form-label">Logo</label>
                                        <input type="text" class="form-control" id="bsValidation1" placeholder="Logo"
                                            required="">
                                        <div class="invalid-feedback">
