                    ...
                    <div class="tab-content" id="danger-pills-tabContent">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="row g-3 needs-validation" novalidate method="POST"
                                        ...
                                        @csrf
                                        <input type="hidden" name="id" id="general_id">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" name="bussiness_address_1"
                                                id="bussiness_address_1" rows="3" required></textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" name="copyright_context"
                                                id="copyright_context" rows="3" required></textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" name="footer_about_company"
                                                id="footer_about_company" rows="3" required></textarea>
                        ...
                        <div class="tab-pane fade" id="danger-pills-profile" role="tabpanel">
                            <div class="card">
                                <div class="card-body">
                                    <form class="row g-3 needs-validation" novalidate method="POST"
                                        enctype="multipart/form-data" id="SocialForm">
                                        @csrf
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="url" class="form-control" name="google_plus_url"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="url" class="form-control" name="pintrest_url"
                        ...
                        <div class="tab-pane fade" id="danger-pills-contact" role="tabpanel">
                            <div class="card">
                                <div class="card-body">
                                    <form class="row g-3 needs-validation" novalidate method="POST"
                                        enctype="multipart/form-data" id="MetaSetting">
                                        @csrf
                                        <div class="col-md-6">
                                            <label for="default_meta_title" class="form-label">Default Meta Title
                                            </label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="meta_description" class="form-label">Default Meta
                                                Description</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="extra_meta" id="extra_meta"
                                                required>
...
$('#generalForm').on('submit', function(e) {
    ...
    $.ajax({
        url: "/admin/general/settin/store-or-update",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
        success: function(res) {
            ...
            $('#generalForm')[0].reset();
            loadSettings(); // Optional: Refresh form values
        }
    });
});
...
function loadSettings() {
    $.get("/admin/general/settin/get", function(data) {
        if (data) {
            $('[name="site_name"]').val(data.site_name);
            $('[name="search_distance"]').val(data.search_distance);
            $('[name="primary_phone"]').val(data.primary_phone);
            $('[name="alternative_phone"]').val(data.alternative_phone);
            $('[name="website_email"]').val(data.website_email);
            $('[name="booking_email"]').val(data.booking_email);
            $('[name="contact_email"]').val(data.contact_email);
            $('[name="bussiness_address_1"]').val(data.bussiness_address_1);
            $('[name="copyright_context"]').val(data.copyright_context);
            $('[name="footer_about_company"]').val(data.footer_about_company);
            $('[name="slider_title[]"]').val(data.slider_title);
            $('[name="button_name[]"]').val(data.button_name);
            $('[name="slider_link[]"]').val(data.slider_link);
        }
    });
}

// Optional: Auto-load on page
$(document).ready(function () {
    loadSettings();
});
</script>
...
<script>
    ...
    $('#SocialForm').on('submit', function (e) {
        ...
        $.ajax({
            url: "/admin/social-links/store-or-update",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    function loadSocialLinks() {
        $.get("/admin/social-links/get", function (data) {
            if (data) {
                ...
                $('#google_plus_url').val(data.google_plus_url);
                $('#pintrest_url').val(data.pintrest_url);
            }
        });
    }
});
...
$(document).ready(function () {
    ...
    $('#MetaSetting').on('submit', function (e) {
        e.preventDefault();
        let formData = new FormData(this);

        $.ajax({
            url: "/admin/default-seo/store-or-update",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    function loadDefaultSeo() {
        $.get("/admin/default-seo/get", function (data) {
            if (data) {
                $('#default_meta_title').val(data.default_meta_title);
                $('#meta_keyword').val(data.meta_keyword);
                $('#meta_description').val(data.meta_description);
                $('#extra_meta').val(data.extra_meta);
            }
        });
    }
});
