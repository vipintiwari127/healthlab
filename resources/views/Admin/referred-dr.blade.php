...
<div class="wrapper">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addDoctorModal">Add Doctor</button>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3 needs-validation" id="doctorEditForm" novalidate>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="edit_specialization" name="specialization" rows="3"
                                    required></textarea>
                            </div>
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
